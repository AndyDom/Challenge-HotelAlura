...
public class Busqueda extends JFrame {
	...
	public Busqueda() {
		...
		lblTitulo.setBounds(287, 62, 383, 42);
		...
		txtBuscar.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				 if (txtBuscar.getText().equals("  Ingrese el numero de reserva")) {
					 txtBuscar.setText("");
		...
		separator_1_2.setBounds(487, 159, 245, 2);
	...
	private void LlenarTablaReservas() {
		...
		try {
			for (Reserva reservas : reserva) {
				modelo.addRow(new Object[] { reservas.getId(), reservas.getFechaEntrada(), reservas.getFechaSalida(), reservas.getTarifa(), reservas.getFormaPago() });
			}
		} catch (Exception e) {
			throw e;
		}
	...
	private void ActualizarReservas() {		
        ...
        .ifPresentOrElse(fila -> {
			...
			String tarifa = (String) modelo.getValueAt(tbReservas.getSelectedRow(), 3);
			String formaPago = (String) modelo.getValueAt(tbReservas.getSelectedRow(), 4);
			Integer id = Integer.valueOf(modelo.getValueAt(tbReservas.getSelectedRow(), 0).toString());
			this.reservaController.actualizar(fechaEntrada,fechaSalida, tarifa, formaPago, id);
